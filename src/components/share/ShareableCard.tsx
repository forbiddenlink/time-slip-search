    ...
    <div className="space-y-4">
      ...
      >
        <div className="text-center mb-4">
          ...
          <h3 className="text-2xl font-bold text-aged-cream">{dateDisplay}</h3>
        </div>

        <div className="space-y-3 text-aged-cream">
          {topSong && (
      ...
      <div className="flex gap-2">
        <button
          onClick={handleShare}
          className="flex-1 px-4 py-2 bg-timeslip-500 hover:bg-timeslip-600 text-aged-cream rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
        >
        ...
        <button
          ...
          className="px-4 py-2 bg-white/10 hover:bg-white/20 text-aged-cream rounded-lg font-medium transition-colors"
        >
          Copy
        </button>
      </div>
