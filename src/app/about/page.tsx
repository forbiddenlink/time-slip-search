    ...
    <main className="min-h-screen bg-crt-black text-aged-cream">
      <div className="container mx-auto max-w-3xl px-4 py-12 space-y-8">
        ...
        <section className="space-y-4 text-aged-cream/80 leading-relaxed">
          ...
          <p>
            TimeSlipSearch was built by Elizabeth Stein for the Algolia Agent Studio Challenge 2026 and is designed to feel fast, playful, and information-dense. Under the hood, the app indexes multiple datasets and uses natural language date parsing so users can type flexible queries such as specific dates, seasons, and year-based prompts.
          </p>
          <p>
            Primary data comes from public and licensed sources, including Billboard history, The Movie Database, Wikimedia event feeds, and FRED economic indicators. I continuously improve source quality, matching logic, and result presentation so each date tells a clearer story.
          </p>
          <p>
            I prioritize transparent sourcing and reproducibility. Music rankings are anchored in public chart references. Historical events use curated encyclopedia and feed sources with date-level granularity. Economic data draws from trusted public datasets designed for historical analysis. Wherever possible, I normalize source timestamps and formats so users can compare across domains without manually translating dates, categories, or units.
          </p>
          <p>
          ...
          <p>
            I treat this project as an evolving research product rather than a static archive. As I collect feedback, I refine parsing accuracy, enrich context in responses, and improve accessibility for keyboard and assistive-technology users. If you spot gaps or inaccuracies, contact me so I can fix and document them.
          </p>
        </section>
